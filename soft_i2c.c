...
#define I2C_SDA_SOFT            B, 1, MODE_OUTPUT_PUSH_PULL, SPEED_50MHZ, 1
#define I2C_SCL_SOFT            B, 1, MODE_OUTPUT_PUSH_PULL, SPEED_50MHZ, 1
...
bool soft_i2c_write(uint8_t hwAddress, uint8_t regAddress, uint8_t *data, uint32_t size)
{
    bool state;
...
bool soft_i2c_read(uint8_t hwAddress, uint8_t regAddress, uint8_t *data, uint32_t size)
{
    bool state;
...
bool soft_i2c_readByte(uint8_t hwAddress, uint8_t regAddress, uint8_t *data)
{
    return soft_i2c_read(hwAddress, regAddress, (uint8_t *)data, sizeof(uint8_t));
}

bool soft_i2c_readWord(uint8_t hwAddress, uint8_t regAddress, uint16_t *data)
{
    return soft_i2c_read(hwAddress, regAddress, (uint8_t *)data, sizeof(uint16_t));
}

bool soft_i2c_readDWord(uint8_t hwAddress, uint8_t regAddress, uint32_t *data)
{
    return soft_i2c_read(hwAddress, regAddress, (uint8_t *)data, sizeof(uint32_t));
}

bool soft_i2c_writeByte(uint8_t hwAddress, uint8_t regAddress, uint8_t data)
{
    return soft_i2c_write(hwAddress, regAddress, (uint8_t *)&data, sizeof(uint8_t));
}

bool soft_i2c_writeWord(uint8_t hwAddress, uint8_t regAddress, uint16_t data)
{
    return soft_i2c_write(hwAddress, regAddress, (uint8_t *)&data, sizeof(uint16_t));
}

bool soft_i2c_writeDWord(uint8_t hwAddress, uint8_t regAddress, uint32_t data)
{
    return soft_i2c_write(hwAddress, regAddress, (uint8_t *)&data, sizeof(uint32_t));
}
...
bool check_soft_i2c(uint8_t hwAddress)
{
    i2c_start();
